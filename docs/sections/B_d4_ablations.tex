...
The \S d.4 ablation suite isolates which mechanical knob of \optCoupled{} carries the dense-LLaMA-60M gain. All cells run on A0 (SwiGLU + RoPE + RMSNorm), $1.2$\,B tokens, single-seed wide / multi-seed narrow per ablation. At report time 104 of the 105 planned cells have synced to wandb project \code{coupled-muon-ablation}; the figures below should be regenerated once the final cell lands (see Appendix~\ref{app:repro} for the refresh command).
