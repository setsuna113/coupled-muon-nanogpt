...
\paragraph{Scope.}
This report covers Stage~1 (A0, an in-repo LLaMA-like 60M harness reproduction rather than a proof of full external LLaMA equivalence; wandb project \code{coupled-muon-A0-repro}) and Stage~2 (dense ladder B/C/D/E/G/H at 60M Common-Size, wandb project \code{coupled-muon-ladder}). Stage~3 sparse-MoE rungs I, I', J, K, L, M, N are interpreted in the separate Part~II report against the 2026-05-19 W\&B snapshot. The \S d.4 dense ablation suite (\code{coupled\_steps}, \code{final\_polish}, per-pair coupling) remains in Appendix~\ref{app:d4}.
