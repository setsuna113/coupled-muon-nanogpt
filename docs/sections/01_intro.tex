...
\paragraph{Scope.}
This report covers Stage~1 (A0 LLaMA-60M reproduction, wandb project \code{coupled-muon-A0-repro}) and Stage~2 (dense ladder B/C/D/E/G/H at 60M Common-Size, wandb project \code{coupled-muon-ladder}). Stage~3 (MoE rungs I, I', J, K, L, M, N) is dispatched on rigs A and B; the data are not yet on hand and are out of scope. The \S d.4 ablation suite (\code{coupled\_steps}, \code{final\_polish}, per-pair coupling) is summarised in Appendix~\ref{app:d4}.
